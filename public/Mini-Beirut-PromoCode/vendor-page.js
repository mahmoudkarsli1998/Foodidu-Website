...
function copyPromoCode(code) {
  navigator.clipboard
    ...
    .then(() => {
      ...
      showVendorNotification(`Mini Beirut promo code "${code}" copied to clipboard! 🎉`, "success");
...
function openVendorApp(vendor, platform) {
  ...
  const vendorApps = {
    "mini-beirut": {
      ios: "https://apps.apple.com/eg/app/mini-beirut/id123456791",
      android: "https://play.google.com/store/apps/details?id=com.minibeirut.eg",
    },
  };
...
function openVendorWebsite(vendor) {
  const vendorWebsites = {
    "mini-beirut": "https://www.minibeirut.com.eg/",
  };
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("Mini Beirut vendor page loaded");

  if (typeof gtag !== "undefined") {
    gtag("event", "page_view", {
      page_title: "Vendor Page - Mini Beirut",
