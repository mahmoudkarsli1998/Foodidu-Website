...
// ====================
// Rabbit Notification (original style + close + draggable)
// ====================
function showRabbitNotification(message, type = "info") {
  // Create container if not exist
  let container = document.querySelector(".rabbit-notification-container");
  if (!container) {
    container = document.createElement("div");
    container.className = "rabbit-notification-container";
...
.rabbit-notification.show {
  opacity: 1;
  transform: translateX(0);
}

.rabbit-notification.hide {
  opacity: 0;
  transform: translateX(100%);
}

.rabbit-notification.success { background: #059669; }
.rabbit-notification.error { background: #dc2626; }
.rabbit-notification.info { background: #3b82f6; }

.rabbit-notification .close-btn {
  position: absolute;
  top: 6px;
  right: 10px;
  border: none;
...
.rabbit-notification .close-btn:hover {
  opacity: 1;
}
