...
function copyPromoCode(code) {
  navigator.clipboard
    ...
    .then(() => {
      ...
      showVendorNotification(`Butcher's Burger promo code "${code}" copied to clipboard! 🎉`, "success");
...
function openVendorApp(vendor, platform) {
  ...
  const vendorApps = {
    "butchers-burger": {
      ios: "https://apps.apple.com/eg/app/butchers-burger/id123456790",
      android: "https://play.google.com/store/apps/details?id=com.butchersburger.eg",
    },
  };
...
function openVendorWebsite(vendor) {
  const vendorWebsites = {
    "butchers-burger": "https://www.butchersburger.com.eg/",
  };
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("Butcher's Burger vendor page loaded");

  if (typeof gtag !== "undefined") {
    gtag("event", "page_view", {
      page_title: "Vendor Page - Butcher's Burger",
