...
function copyPromoCode(code) {
  navigator.clipboard
    ...
    .then(() => {
      ...
      showVendorNotification(`BreadFast promo code "${code}" copied to clipboard! 🎉`, "success");
...
function openVendorApp(vendor, platform) {
  ...
  const vendorApps = {
    "breadfast": {
      ios: "https://apps.apple.com/eg/app/breadfast/id123456794",
      android: "https://play.google.com/store/apps/details?id=com.breadfast.eg",
    },
  };
...
function openVendorWebsite(vendor) {
  const vendorWebsites = {
    "breadfast": "https://www.breadfast.com.eg/",
  };
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("BreadFast vendor page loaded");

  if (typeof gtag !== "undefined") {
    gtag("event", "page_view", {
      page_title: "Vendor Page - BreadFast",
