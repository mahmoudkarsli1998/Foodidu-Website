...
function copyPromoCode(code) {
  navigator.clipboard
    ...
    .then(() => {
      ...
      showVendorNotification(`Pizza Hut promo code "${code}" copied to clipboard! 🎉`, "success");
...
function openVendorApp(vendor, platform) {
  ...
  const vendorApps = {
    "pizza-hut": {
      ios: "https://apps.apple.com/eg/app/pizza-hut/id321123456",
      android: "https://play.google.com/store/apps/details?id=com.pizzahut.eg",
    },
  };
...
function openVendorWebsite(vendor) {
  const vendorWebsites = {
    "pizza-hut": "https://www.pizzahut.com.eg/",
  };
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("Pizza Hut vendor page loaded");

  if (typeof gtag !== "undefined") {
    gtag("event", "page_view", {
      page_title: "Vendor Page - Pizza Hut",
