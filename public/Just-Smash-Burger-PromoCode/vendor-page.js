...
function copyPromoCode(code) {
  navigator.clipboard
    ...
    .then(() => {
      ...
      showVendorNotification(`Just Smash Burger promo code "${code}" copied to clipboard! 🎉`, "success");
...
function openVendorApp(vendor, platform) {
  ...
  const vendorApps = {
    "just-smash-burger": {
      ios: "https://apps.apple.com/eg/app/just-smash-burger/id123456789",
      android: "https://play.google.com/store/apps/details?id=com.justsmashburger.eg",
    },
  };
...
function openVendorWebsite(vendor) {
  const vendorWebsites = {
    "just-smash-burger": "https://www.justsmashburger.com.eg/",
  };
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("Just Smash Burger vendor page loaded");

  if (typeof gtag !== "undefined") {
    gtag("event", "page_view", {
      page_title: "Vendor Page - Just Smash Burger",
